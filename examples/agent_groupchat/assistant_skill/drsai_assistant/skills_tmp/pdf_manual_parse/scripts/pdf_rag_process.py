...
async def main():
    ...
    # DOCMENT_ID = 'ea477808145511f1a8850242ac120006'
    # DOCMENT_ID = "da82759e184c11f198850242ac120006"
    DOCMENT_ID = "4a37cf7e1c8f11f187230242ac120006"
    # common_keywords = [
    #         'scan', 'motor', 'count', 'hscan', 'kscan', 'lscan',
    #         'ascan', 'dscan', 'mesh', 'diffractometer', 'spec',
    #         'wh', 'wa', 'set', 'newfile', 'comment'
    #     ]
    ...
    uploader = ManualRAGUploader(
        ...
        index_json_flie="/home/xiongdb/drsai_dev/docs/manual/opendrsai-manual_index.json",
    ...
    # await uploader.upload_entries(
    #     upload_detailed_content=False,
    # )
    ...
    #     "index_json_file": "/home/xiongdb/drsai_dev/docs/manual/opendrsai-manual_index.json"
    # }
    # await uploader.update_document_matadata(
    #     document_id = DOCMENT_ID,
    #     meta_fields = meta_fields)
