...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 453).then(__webpack_require__.bind(__webpack_require__, 70731)),"component---src-pages-auth-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-auth-tsx */ 577).then(__webpack_require__.bind(__webpack_require__, 74749)),"component---src-pages-index-tsx":()=>Promise.all(/* import() | component---src-pages-index-tsx */[__webpack_require__.e(593), __webpack_require__.e(869), __webpack_require__.e(784), __webpack_require__.e(601), __webpack_require__.e(245)]).then(__webpack_require__.bind(__webpack_require__, 54603)),"component---src-pages-login-tsx":()=>Promise.all(/* import() | component---src-pages-login-tsx */[__webpack_require__.e(601), __webpack_require__.e(626)]).then(__webpack_require__.bind(__webpack_require__, 46981)),"component---src-pages-sso-login-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-sso-login-tsx */ 300).then(__webpack_require__.bind(__webpack_require__, 46592))};
...
// 公开路由列表（不需要登录即可访问）
const PUBLIC_ROUTES=["/login","/sso-login"];// 标准化路径，兼容 Gatsby 的 trailing slash（/login 与 /login/ 视为同一路由）
...
const user_email=localStorage.getItem("user_email");const isAuthenticated=!!user_email;const currentPath=location.pathname;const normalizedPath=normalizePath(currentPath);const isPublicRoute=PUBLIC_ROUTES.some(r=>normalizePath(r)===normalizedPath);if(isAuthenticated){// 已登录态
// 如果访问登录页，重定向到首页
if(normalizedPath==="/login"||normalizedPath==="/sso-login"){navigate("/",{replace:true});return;}}else{// 未登录态
// 如果访问非公开路由，重定向到登录页
if(!isPublicRoute){const loginPath= true?"/login":0;// 避免重复重定向（标准化后比较，兼容 /login 与 /login/）
if(normalizedPath!==normalizePath(loginPath)){navigate(loginPath,{replace:true});return;}}}};checkAuth();// 只依赖 pathname，不依赖 navigate（因为 navigate 现在是稳定的）
...
//# sourceMappingURL=app-ca16c980b46bd4322266.js.map