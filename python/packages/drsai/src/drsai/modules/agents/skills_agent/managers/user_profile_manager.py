...
class UserProfileManager:
    ...
    def _initialize_files(self):
        ...
        if not self.user_config_path.exists():
            ...
            self.user_config = UserProfile(**config_data)
    ...
    def _create_user_config(self):
        ...
        self.user_config: UserProfile = user_config
        with self.user_config_path.open("w", encoding='utf-8') as f:
            json.dump(user_config.model_dump(), f, indent=4, ensure_ascii=False)
...
## Agent Capabilities
 {self.agent_name} is a professional scientific data analysis assistant with the following capabilities:
